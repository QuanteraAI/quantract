...
export const Navbar = () => {
    ...
    return (
        <header className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
            <nav
                className={`pointer-events-auto relative flex items-center justify-between px-6 py-4 rounded-full transition-all duration-700 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${scrolled
            ...
            >
                ...
                {/* Links */}
                <div className={`hidden md:flex absolute left-1/2 -translate-x-1/2 gap-8 text-sm font-medium transition-colors duration-500 ${scrolled ? 'text-stone-800' : 'text-stone-600'}`}>
